...
import { fetchKlbTeamTournaments } from '../../../api/klb'
...
export default function TeamTournamentsPage() {
  ...
  return (
    <div>
      <h1 className="text-2xl font-bold text-white mb-5">Турниры · Командный зачёт</h1>
              ...
              <tbody>
                {bySeason[season]
                  ...
                  .map((t, i) => (
                    <tr
                      key={t.tournament_id}
                      onClick={() => navigate(`/klb/team/tournaments/${t.tournament_id}`)}
